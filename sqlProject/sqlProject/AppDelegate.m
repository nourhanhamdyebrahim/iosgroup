...
//    // The directory the application uses to store the Core Data store file. This code uses a directory named "iti.sqlProject" in the application's documents directory.
...
//    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"sqlProject.sqlite"];
//    NSError *error = nil;
